...
interface ButtonProps extends React.ButtonHTMLAttributes<HTMLButtonElement> {
  variant?: 'primary' | 'white' | 'outline' | 'black';
  size?: 'normal' | 'large';
  fullWidth?: boolean;
}
...
const Button: React.FC<ButtonProps> = ({ 
  ...
  const variants = {
    ...
    white: "bg-[var(--color-button-white)] text-black hover:bg-[var(--color-button-white-hover)]",
    outline: "bg-transparent border border-[var(--color-border)] text-[var(--color-primary)] hover:bg-[rgba(29,155,240,0.1)]",
