    ...
    <div className="min-h-screen bg-white text-black flex flex-col px-16 py-10">
        <div className="w-full flex items-center justify-between top-0 bg-white z-50">
            <div className="flex items-center gap-4">
                ...
                <h1 className="text-[22px] font-bold text-black tracking-tight">Terms of Service</h1>
            </div>
        </div>
        <div className="w-full max-w-[650px] px-4 mt-52">
            <h1 className="text-[140px] font-bold leading-none text-black/90 tracking-tight">Terms of Service</h1>
        </div>
        ...
        <div className="w-full max-w-full pl-32 mt-4 p-10">
            <h2 className="text-4xl text-black/90 font-[700]">Summary of our Terms</h2>
            <p className="text-black/90 mt-4 text-md leading-7">
              These Terms of Service (“Terms”) are part of the User Agreement – a legally binding contract governing your relationship with X. <span className="font-bold">You should read these Terms in full, but here are a few key things you should take away:</span>
            </p>
            ...
            <ul className="list-disc pl-10 mt-6 space-y-4 text-black/80 text-[15px] leading-6">
                <li>
                  <span className="font-bold text-black">If you are a recipient of the X Service in the United Kingdom,</span> you may challenge enforcement actions (such as Content removal or account suspension) that breach these Terms by filing a complaint through our internal complaints process or by bringing a claim in a competent court, as provided under the Online Safety Act 2023. You can find details on how to file a complaint <a href="#" className="text-blue-500 hover:underline">here</a>.
                </li>
                <li>
                   <span className="font-bold text-black">If you are a recipient of the X Service in the European Union,</span> you may challenge certain decisions we make under the Digital Services Act (Regulation (EU) 2022/2065) via our internal process or via out-of-court dispute settlement as described <a href="#" className="text-blue-500 hover:underline">here</a>.
                </li>
            </ul>

            <div className="mt-8 text-black/80 text-[15px] leading-6">
               <p className="mb-4">
                 Please also note that these Terms incorporate our Privacy Policy (<a href="https://x.com/privacy" className="text-blue-500 hover:underline">https://x.com/privacy</a>) as well as other terms applicable to your use of the Services and your Content. Finally, these Terms may vary depending on where you live, but in any case, you must be at least 13 years old to use X.
               </p>
            </div>
        </div>
    </div>
